...
hamburguer = Image.open('pics/230446.png')
ice_cream = Image.open('pics/321321.png')
pizza = Image.open('pics/pizza.png')
base_model_structure = Image.open("pics/base_model_structure.png")
